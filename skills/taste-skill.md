...
* **CTA BUTTON WRAP BAN (mandatory):** Button text MUST fit on one line at desktop. If a label like "VIEW SELECTED WORK" wraps to 2 or 3 l

... [OUTPUT TRUNCATED - 37126 chars omitted out of 87126 total] ...

ion, use the verb-noun directly ("Install", "Configure", "Ship") not "Stage 1: Install".
